...
// PRIVATE FUNCTIONS
        ...
        _setElements: function () {
            ...
            this.main.addClass('wd-form sw-main sw-theme-' + this.options.theme);
            // Set anchor elements
        ...
        _setToolbar: function () {
            ...
            var btnNext = (this.options.toolbarSettings.showNextButton !== false) ? $('<button></button>').text(this.options.lang.next).addClass('btn btn-default sw-btn-next wd-btn-next').attr('type','button') : null;
            var btnPrevious = (this.options.toolbarSettings.showPreviousButton !== false) ? $('<button></button>').text(this.options.lang.previous).addClass('btn btn-default sw-btn-prev wd-btn-prev').attr('type','button') : null;
            ...
            switch(this.options.toolbarSettings.toolbarPosition){
                case 'top':
                    toolbarTop = $('<nav></nav>').addClass('wd-form__footer navbar btn-toolbar sw-toolbar sw-toolbar-top');
                    ...
                    break;
                case 'bottom':
                    toolbarBottom = $('<nav></nav>').addClass('wd-form__footer navbar btn-toolbar sw-toolbar sw-toolbar-bottom');
